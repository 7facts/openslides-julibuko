...
EditEventDispatcher.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EditEventDispatcher, factory: EditEventDispatcher.ɵfac });
/** @nocollapse */
EditEventDispatcher.ctorParameters = () => [
    { type: NgZone }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EditEventDispatcher, [{
        type: Injectable
...
EditRef.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EditRef, factory: EditRef.ɵfac });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EditRef, [{
        type: Injectable
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FocusDispatcher, [{
        type: Injectable,
...
CdkEditControl.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkEditControl, selectors: [["form", "cdkEditControl", ""]], hostBindings: function CdkEditControl_HostBindings(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkEditControl, [{
        type: Directive,
        args: [{
...
CdkEditRevert.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkEditRevert, selectors: [["button", "cdkEditRevert", ""]], hostAttrs: ["type", "button"], hostBindings: function CdkEditRevert_HostBindings(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkEditRevert, [{
        type: Directive,
        args: [{
...
CdkEditClose.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkEditClose, selectors: [["", "cdkEditClose", ""]], hostBindings: function CdkEditClose_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function CdkEditClose_click_HostBindingHandler() { return ctx.closeEdit(); })("keyup.enter", function CdkEditClose_keyup_enter_HostBindingHandler() { return ctx.closeEdit(); })("keyup.space", function CdkEditClose_keyup_space_HostBindingHandler() { return ctx.closeEdit(); });
    } } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkEditClose, [{
        type: Directive,
...
PopoverEditPositionStrategyFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PopoverEditPositionStrategyFactory, factory: PopoverEditPositionStrategyFactory.ɵfac });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PopoverEditPositionStrategyFactory, [{
        type: Injectable
    }], null, null); })();
if (false) {
    /**
...
DefaultPopoverEditPositionStrategyFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DefaultPopoverEditPositionStrategyFactory, factory: DefaultPopoverEditPositionStrategyFactory.ɵfac });
/** @nocollapse */
DefaultPopoverEditPositionStrategyFactory.ctorParameters = () => [
    { type: Directionality },
    { type: Overlay }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DefaultPopoverEditPositionStrategyFactory, [{
        type: Injectable
...
EditServices.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EditServices, factory: EditServices.ɵfac });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EditServices, [{
        type: Injectable
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FocusEscapeNotifierFactory, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
...
CdkEditable.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkEditable, selectors: [["table", "editable", ""], ["cdk-table", "editable", ""], ["mat-table", "editable", ""]], features: [ɵngcc0.ɵɵProvidersFeature([EditEventDispatcher, EditServices])] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkEditable, [{
        type: Directive,
        args: [{
...
CdkPopoverEdit.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkPopoverEdit, selectors: [["", "cdkPopoverEdit", "", 3, "cdkPopoverEditTabOut", ""]], hostAttrs: [1, "cdk-popover-edit-cell"], hostVars: 2, hostBindings: function CdkPopoverEdit_HostBindings(rf, ctx) { if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkPopoverEdit, [{
        type: Directive,
        args: [{
...
CdkPopoverEditTabOut.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkPopoverEditTabOut, selectors: [["", "cdkPopoverEdit", "", "cdkPopoverEditTabOut", ""]], hostAttrs: [1, "cdk-popover-edit-cell"], hostVars: 2, hostBindings: function CdkPopoverEditTabOut_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵattribute("tabindex", ctx.disabled ? null : 0)("aria-haspopup", !ctx.disabled);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkPopoverEditTabOut, [{
        type: Directive,
        args: [{
...
CdkRowHoverContent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkRowHoverContent, selectors: [["", "cdkRowHoverContent", ""]] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkRowHoverContent, [{
        type: Directive,
        args: [{
...
CdkEditOpen.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkEditOpen, selectors: [["", "cdkEditOpen", ""]], hostBindings: function CdkEditOpen_HostBindings(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkEditOpen, [{
        type: Directive,
        args: [{
...
CdkPopoverEditModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: CdkPopoverEditModule });
CdkPopoverEditModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function CdkPopoverEditModule_Factory(t) { return new (t || CdkPopoverEditModule)(); }, providers: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(CdkPopoverEditModule, { declarations: function () { return [CdkPopoverEdit,
        ...
        CdkEditable,
        CdkEditOpen]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkPopoverEditModule, [{
        type: NgModule,
        args: [{
                imports: [
                    OverlayModule,

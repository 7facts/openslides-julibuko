...
function PblNgridDefaultDetailRowParentComponent_pbl_ngrid_row_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "pbl-ngrid-row", 1);
} if (rf & 2) {
    const row_r1 = ctx.$implicit;
    const gridInstance_r2 = ctx.gridInstance;
    ɵngcc0.ɵɵproperty("grid", gridInstance_r2)("detailRow", row_r1);
} }
const _c0 = ["detailRow", ""];
...
PblNgridDetailRowDefDirective.ɵfac = function PblNgridDetailRowDefDirective_Factory(t) { return new (t || PblNgridDetailRowDefDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridRegistryService)); };
PblNgridDetailRowDefDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridDetailRowDefDirective, selectors: [["", "pblNgridDetailRowDef", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
PblNgridDetailRowParentRefDirective.ɵfac = function PblNgridDetailRowParentRefDirective_Factory(t) { return new (t || PblNgridDetailRowParentRefDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridRegistryService)); };
PblNgridDetailRowParentRefDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridDetailRowParentRefDirective, selectors: [["", "pblNgridDetailRowParentRef", ""]], inputs: { columns: ["pblNgridDetailRowParentRef", "columns"], when: ["pblNgridDetailRowParentRefWhen", "when"] }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
PblNgridDefaultDetailRowParentComponent.ɵfac = function PblNgridDefaultDetailRowParentComponent_Factory(t) { return new (t || PblNgridDefaultDetailRowParentComponent)(); };
PblNgridDefaultDetailRowParentComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PblNgridDefaultDetailRowParentComponent, selectors: [["pbl-ngrid-default-detail-row-parent"]], decls: 1, vars: 0, consts: [[3, "grid", "detailRow", 4, "pblNgridDetailRowParentRef"], [3, "grid", "detailRow"]], template: function PblNgridDefaultDetailRowParentComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, PblNgridDefaultDetailRowParentComponent_pbl_ngrid_row_0_Template, 1, 2, "pbl-ngrid-row", 0);
    } }, directives: function () { return [PblNgridDetailRowParentRefDirective,
        PblNgridDetailRowComponent]; }, encapsulation: 2 });
...
PblNgridDetailRowPluginDirective.ɵfac = function PblNgridDetailRowPluginDirective_Factory(t) { return new (t || PblNgridDetailRowPluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector)); };
PblNgridDetailRowPluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridDetailRowPluginDirective, selectors: [["pbl-ngrid", "detailRow", ""]], inputs: { whenContextChange: "whenContextChange", detailRow: "detailRow", singleDetailRow: "singleDetailRow", excludeToggleFrom: "excludeToggleFrom" }, outputs: { toggleChange: "toggleChange", toggledRowContextChange: "toggledRowContextChange" }, exportAs: ["pblNgridDetailRow"] });
/** @nocollapse */
...
PblNgridDetailRowComponent.ɵfac = function PblNgridDetailRowComponent_Factory(t) { return new (t || PblNgridDetailRowComponent)(ɵngcc0.ɵɵdirectiveInject(EXT_API_TOKEN, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef)); };
PblNgridDetailRowComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PblNgridDetailRowComponent, selectors: [["pbl-ngrid-row", "detailRow", ""]], hostAttrs: ["role", "row", 1, "pbl-ngrid-row", "pbl-row-detail-parent"], hostVars: 1, hostBindings: function PblNgridDetailRowComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keydown", function PblNgridDetailRowComponent_keydown_HostBindingHandler($event) { return ctx.handleKeydown($event); });
    } if (rf & 2) {
        ɵngcc0.ɵɵattribute("tabindex", ctx.grid == null ? null : ctx.grid.rowFocus);
    } }, inputs: { row: ["detailRow", "row"] }, exportAs: ["pblNgridDetailRow"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: CdkRow, useExisting: PblNgridDetailRowComponent_1 }
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], attrs: _c0, decls: 1, vars: 0, consts: [["cdkCellOutlet", ""]], template: function PblNgridDetailRowComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementContainer(0, 0);
    } }, directives: [ɵngcc2.CdkCellOutlet], styles: [".pbl-row-detail-parent { position: relative; cursor: pointer; }"], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDetailRowDefDirective, [{
        type: Directive,
        args: [{ selector: '[pblNgridDetailRowDef]' }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: ɵngcc1.PblNgridRegistryService }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDetailRowParentRefDirective, [{
        type: Directive,
        args: [{
                selector: '[pblNgridDetailRowParentRef]',
                inputs: ['columns: pblNgridDetailRowParentRef', 'when: pblNgridDetailRowParentRefWhen']
            }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: ɵngcc0.IterableDiffers }, { type: ɵngcc1.PblNgridRegistryService }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDefaultDetailRowParentComponent, [{
        type: Component,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDetailRowPluginDirective, [{
        type: Directive,
        args: [{ selector: 'pbl-ngrid[detailRow]', exportAs: 'pblNgridDetailRow' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc1.PblNgridPluginController }, { type: ɵngcc0.Injector }]; }, { whenContextChange: [{
            type: Input
        }], toggleChange: [{
            type: Output
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDetailRowComponent, [{
        type: Component,
        args: [{
                ...
                type: Inject,
                args: [EXT_API_TOKEN]
            }] }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.ViewContainerRef }]; }, { row: [{
            type: Input,
            args: ['detailRow']
        }] }); })();
if (false) {
...
PblNgridDetailRowModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridDetailRowModule });
PblNgridDetailRowModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridDetailRowModule_Factory(t) { return new (t || PblNgridDetailRowModule)(); }, imports: [[CommonModule, CdkTableModule, PblNgridModule, PblNgridTargetEventsModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridDetailRowModule, { declarations: function () { return [PblNgridDetailRowPluginDirective,
        PblNgridDetailRowComponent,
        PblNgridDetailRowParentRefDirective,
        PblNgridDetailRowDefDirective,
        PblNgridDefaultDetailRowParentComponent]; }, imports: function () { return [CommonModule, CdkTableModule, PblNgridModule, PblNgridTargetEventsModule]; }, exports: function () { return [PblNgridDetailRowPluginDirective,
        PblNgridDetailRowComponent,
        PblNgridDetailRowParentRefDirective,
        PblNgridDetailRowDefDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDetailRowModule, [{
        type: NgModule,
        args: [{

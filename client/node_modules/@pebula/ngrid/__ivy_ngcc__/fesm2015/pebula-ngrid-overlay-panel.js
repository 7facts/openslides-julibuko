...
PblNgridOverlayPanelFactory.ɵfac = function PblNgridOverlayPanelFactory_Factory(t) { return new (t || PblNgridOverlayPanelFactory)(ɵngcc0.ɵɵinject(ɵngcc1.Overlay), ɵngcc0.ɵɵinject(ɵngcc2.Directionality)); };
PblNgridOverlayPanelFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PblNgridOverlayPanelFactory, factory: PblNgridOverlayPanelFactory.ɵfac });
/** @nocollapse */
PblNgridOverlayPanelFactory.ctorParameters = () => [
    { type: Overlay },
    { type: Directionality }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridOverlayPanelFactory, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.Overlay }, { type: ɵngcc2.Directionality }]; }, null); })();
if (false) {
    /**
     * @type {?}
     * @private
...
PblNgridOverlayPanelDef.ɵfac = function PblNgridOverlayPanelDef_Factory(t) { return new (t || PblNgridOverlayPanelDef)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridRegistryService)); };
PblNgridOverlayPanelDef.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridOverlayPanelDef, selectors: [["", "pblNgridOverlayPanelDef", ""]], inputs: { name: ["pblNgridOverlayPanelDef", "name"] }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridOverlayPanelDef, [{
        type: Directive,
        args: [{ selector: '[pblNgridOverlayPanelDef]' }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: ɵngcc3.PblNgridRegistryService }]; }, { name: [{
            type: Input,
...
PblNgridOverlayPanelModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridOverlayPanelModule });
PblNgridOverlayPanelModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridOverlayPanelModule_Factory(t) { return new (t || PblNgridOverlayPanelModule)(); }, providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridOverlayPanelModule, { declarations: function () { return [PblNgridOverlayPanelDef]; }, imports: function () { return [CommonModule,
        OverlayModule,
        BidiModule]; }, exports: function () { return [PblNgridOverlayPanelDef]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridOverlayPanelModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,

...
class PblNgridTransposePluginDirective {
    ...
    constructor(grid, pluginCtrl, config) {
         ...
         * @return {?}
         */
        e => e.kind === 'onInit')), take(1), UnRx(this, this.grid))
            .subscribe((/**
         * @param {?} e
         * @return {?}
         */
...
PblNgridTransposePluginDirective.ɵfac = function PblNgridTransposePluginDirective_Factory(t) { return new (t || PblNgridTransposePluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridConfigService)); };
PblNgridTransposePluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridTransposePluginDirective, selectors: [["pbl-ngrid", "transpose", ""]], inputs: { header: ["transposeHeaderCol", "header"], defaultCol: ["transposeDefaultCol", "defaultCol"], matchTemplates: "matchTemplates", transpose: "transpose" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridTransposePluginDirective, [{
        type: Directive,
        args: [{ selector: 'pbl-ngrid[transpose]' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc1.PblNgridPluginController }, { type: ɵngcc1.PblNgridConfigService }]; }, { header: [{
            type: Input,
...
PblNgridTransposeModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridTransposeModule });
PblNgridTransposeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridTransposeModule_Factory(t) { return new (t || PblNgridTransposeModule)(); }, imports: [[CommonModule, PblNgridModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridTransposeModule, { declarations: function () { return [PblNgridTransposePluginDirective]; }, imports: function () { return [CommonModule, PblNgridModule]; }, exports: function () { return [PblNgridTransposePluginDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridTransposeModule, [{
        type: NgModule,
        args: [{

...
PblNgridStickyPluginDirective.ɵfac = function PblNgridStickyPluginDirective_Factory(t) { return new (t || PblNgridStickyPluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController)); };
PblNgridStickyPluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridStickyPluginDirective, selectors: [["pbl-ngrid", "stickyColumnStart", ""], ["pbl-ngrid", "stickyColumnEnd", ""], ["pbl-ngrid", "stickyHeader", ""], ["pbl-ngrid", "stickyFooter", ""]], inputs: { stickyColumnStart: "stickyColumnStart", stickyColumnEnd: "stickyColumnEnd", stickyHeader: "stickyHeader", stickyFooter: "stickyFooter" } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridStickyPluginDirective, [{
        type: Directive,
        args: [{ selector: 'pbl-ngrid[stickyColumnStart], pbl-ngrid[stickyColumnEnd], pbl-ngrid[stickyHeader], pbl-ngrid[stickyFooter]' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc0.IterableDiffers }, { type: ɵngcc1.PblNgridPluginController }]; }, { stickyColumnStart: [{
            type: Input
        }], stickyColumnEnd: [{
            type: Input
        }], stickyHeader: [{
...
PblNgridStickyModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridStickyModule });
PblNgridStickyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridStickyModule_Factory(t) { return new (t || PblNgridStickyModule)(ɵngcc0.ɵɵinject(PblNgridStickyModule, 12), ɵngcc0.ɵɵinject(ɵngcc1.PblNgridConfigService)); }, imports: [[CommonModule, CdkTableModule, PblNgridModule]] });
/** @nocollapse */
PblNgridStickyModule.ctorParameters = () => [
    { type: PblNgridStickyModule, decorators: [{ type: Optional }, { type: SkipSelf }] },
    { type: PblNgridConfigService }
];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridStickyModule, { declarations: function () { return [PblNgridStickyPluginDirective]; }, imports: function () { return [CommonModule, CdkTableModule, PblNgridModule]; }, exports: function () { return [PblNgridStickyPluginDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridStickyModule, [{
        type: NgModule,
        args: [{
    ...
    }], function () { return [{ type: PblNgridStickyModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf

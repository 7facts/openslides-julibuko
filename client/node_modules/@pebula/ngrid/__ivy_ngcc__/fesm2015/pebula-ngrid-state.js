import { PblNgridPluginController, utils, NgridPlugin, PblNgridComponent, PblNgridModule, PblNgridConfigService } from '@pebula/ngrid';
...
PblNgridStatePluginDirective.ɵfac = function PblNgridStatePluginDirective_Factory(t) { return new (t || PblNgridStatePluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController)); };
PblNgridStatePluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridStatePluginDirective, selectors: [["pbl-ngrid", "persistState", ""]], inputs: { loadOptions: "loadOptions", saveOptions: "saveOptions" }, outputs: { afterLoadState: "afterLoadState", afterSaveState: "afterSaveState", onError: "onError" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridStatePluginDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc0.Injector }, { type: ɵngcc1.PblNgridPluginController }]; }, { loadOptions: [{
            type: Input
        }], saveOptions: [{
            type: Input
        }] }); })();
...
PblNgridStatePluginModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridStatePluginModule });
PblNgridStatePluginModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridStatePluginModule_Factory(t) { return new (t || PblNgridStatePluginModule)(ɵngcc0.ɵɵinject(PblNgridStatePluginModule, 12), ɵngcc0.ɵɵinject(ɵngcc1.PblNgridConfigService)); }, providers: [], imports: [[
            CommonModule,
            PblNgridModule,
        ]] });
/** @nocollapse */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridStatePluginModule, { declarations: function () { return [PblNgridStatePluginDirective]; }, imports: function () { return [CommonModule,
        PblNgridModule]; }, exports: function () { return [PblNgridStatePluginDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridStatePluginModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
    ...
    }], function () { return [{ type: PblNgridStatePluginModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf

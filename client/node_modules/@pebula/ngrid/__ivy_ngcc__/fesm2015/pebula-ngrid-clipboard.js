...
PblNgridClipboardPlugin.ɵfac = function PblNgridClipboardPlugin_Factory(t) { return new (t || PblNgridClipboardPlugin)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController)); };
PblNgridClipboardPlugin.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridClipboardPlugin, selectors: [["pbl-ngrid", "clipboard", ""]], inputs: { clpCellSep: "clpCellSep", clpRowSep: "clpRowSep" }, exportAs: ["pblNgridClipboard"] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridClipboardPlugin, [{
        type: Directive,
        args: [{ selector: 'pbl-ngrid[clipboard]', exportAs: 'pblNgridClipboard' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc0.Injector }, { type: ɵngcc1.PblNgridPluginController }]; }, { clpCellSep: [{
            type: Input
        }], clpRowSep: [{
            type: Input
        }] }); })();
...
PblNgridClipboardPluginModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridClipboardPluginModule });
PblNgridClipboardPluginModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridClipboardPluginModule_Factory(t) { return new (t || PblNgridClipboardPluginModule)(ɵngcc0.ɵɵinject(PblNgridClipboardPluginModule, 12), ɵngcc0.ɵɵinject(ɵngcc1.PblNgridConfigService)); }, imports: [[CommonModule, PblNgridModule, PblNgridTargetEventsModule]] });
/** @nocollapse */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridClipboardPluginModule, { declarations: function () { return [PblNgridClipboardPlugin]; }, imports: function () { return [CommonModule, PblNgridModule, PblNgridTargetEventsModule]; }, exports: function () { return [PblNgridClipboardPlugin]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridClipboardPluginModule, [{
        type: NgModule,
        args: [{
    ...
    }], function () { return [{ type: PblNgridClipboardPluginModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf

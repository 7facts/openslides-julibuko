...
import * as ɵngcc3 from '@pebula/ngrid';
import * as ɵngcc4 from '@angular/cdk/bidi';

const _c0 = ["*"];
function DragPluginDefaultTemplatesComponent_pbl_ngrid_drag_resize_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "pbl-ngrid-drag-resize", 2);
} if (rf & 2) {
    const ctx_r2 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("context", ctx_r2);
} }
function DragPluginDefaultTemplatesComponent_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 3);
} if (rf & 2) {
    const ctx_r3 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("pblNgridColumnDrag", ctx_r3);
} }
...
PblDragDrop.ɵfac = function PblDragDrop_Factory(t) { return new (t || PblDragDrop)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(ɵngcc1.ViewportRuler), ɵngcc0.ɵɵinject(ɵngcc2.DragDropRegistry)); };
/** @nocollapse */
...
CdkLazyDropList.ɵfac = function CdkLazyDropList_Factory(t) { return ɵCdkLazyDropList_BaseFactory(t || CdkLazyDropList); };
CdkLazyDropList.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkLazyDropList, selectors: [["", "cdkLazyDropList", ""]], hostAttrs: [1, "cdk-drop-list"], hostVars: 5, hostBindings: function CdkLazyDropList_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, inputs: { directContainerElement: ["cdkDropListDirectContainerElement", "directContainerElement"] }, exportAs: ["cdkLazyDropList"], features: [ɵngcc0.ɵɵProvidersFeature([
...
CdkLazyDrag.ɵfac = function CdkLazyDrag_Factory(t) { return ɵCdkLazyDrag_BaseFactory(t || CdkLazyDrag); };
CdkLazyDrag.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CdkLazyDrag, selectors: [["", "cdkLazyDrag", ""]], hostAttrs: [1, "cdk-drag"], hostVars: 2, hostBindings: function CdkLazyDrag_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("cdk-drag-dragging", ctx._dragRef.isDragging());
    } }, inputs: { rootElementSelectorClass: ["cdkDragRootElementClass", "rootElementSelectorClass"], cdkDropList: "cdkDropList" }, exportAs: ["cdkLazyDrag"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
        ]), ɵngcc0.ɵɵInheritDefinitionFeature] });
...
PblDragHandle.ɵfac = function PblDragHandle_Factory(t) { return new (t || PblDragHandle)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.CdkDrag, 8)); };
PblDragHandle.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblDragHandle, selectors: [["", "pblDragHandle", ""]], hostAttrs: [1, "cdk-drag-handle"], features: [ɵngcc0.ɵɵProvidersFeature([
            {
...
PblNgridRowReorderPluginDirective.ɵfac = function PblNgridRowReorderPluginDirective_Factory(t) { return new (t || PblNgridRowReorderPluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDrop), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.CdkDropListGroup, 12)); };
PblNgridRowReorderPluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridRowReorderPluginDirective, selectors: [["pbl-ngrid", "rowReorder", ""]], hostAttrs: [1, "cdk-drop-list"], hostVars: 7, hostBindings: function PblNgridRowReorderPluginDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("id", ctx.id);
        ɵngcc0.ɵɵclassProp("cdk-drop-list-dragging", ctx._dropListRef.isDragging())("cdk-drop-list-receiving", ctx._dropListRef.isReceiving())("pbl-row-reorder", ctx.rowReorder && !(ctx.grid.ds == null ? null : ctx.grid.ds.sort.sort == null ? null : ctx.grid.ds.sort.sort.order) && !(ctx.grid.ds == null ? null : ctx.grid.ds.filter == null ? null : ctx.grid.ds.filter.filter));
    } }, inputs: { directContainerElement: ["cdkDropListDirectContainerElement", "directContainerElement"], rowReorder: "rowReorder" }, exportAs: ["pblNgridRowReorder"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
...
PblNgridRowDragDirective.ɵfac = function PblNgridRowDragDirective_Factory(t) { return new (t || PblNgridRowDragDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(CDK_DROP_LIST, 12), ɵngcc0.ɵɵdirectiveInject(DOCUMENT), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(CDK_DRAG_CONFIG), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDrop), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
PblNgridRowDragDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridRowDragDirective, selectors: [["", "pblNgridRowDrag", ""]], hostAttrs: [1, "cdk-drag"], hostVars: 2, hostBindings: function PblNgridRowDragDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("cdk-drag-dragging", ctx._dragRef.isDragging());
    } }, inputs: { context: ["pblNgridRowDrag", "context"], cdkDropList: "cdkDropList", rootElementSelectorClass: ["cdkDragRootElementClass", "rootElementSelectorClass"] }, exportAs: ["pblNgridRowDrag"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
...
PblNgridColumnReorderPluginDirective.ɵfac = function PblNgridColumnReorderPluginDirective_Factory(t) { return new (t || PblNgridColumnReorderPluginDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDrop), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.CdkDropListGroup, 12)); };
PblNgridColumnReorderPluginDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridColumnReorderPluginDirective, selectors: [["pbl-ngrid", "columnReorder", ""]], hostAttrs: [1, "cdk-drop-list"], hostVars: 5, hostBindings: function PblNgridColumnReorderPluginDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("id", ctx.id);
        ɵngcc0.ɵɵclassProp("cdk-drop-list-dragging", ctx._dropListRef.isDragging())("cdk-drop-list-receiving", ctx._dropListRef.isReceiving());
    } }, inputs: { directContainerElement: ["cdkDropListDirectContainerElement", "directContainerElement"], columnReorder: "columnReorder", manualOverride: "manualOverride" }, outputs: { dragging: "cdkDropDragging" }, exportAs: ["pblNgridColumnReorder"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
...
PblNgridColumnDragDirective.ɵfac = function PblNgridColumnDragDirective_Factory(t) { return new (t || PblNgridColumnDragDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(CDK_DROP_LIST, 12), ɵngcc0.ɵɵdirectiveInject(DOCUMENT), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(CDK_DRAG_CONFIG), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDrop), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
PblNgridColumnDragDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridColumnDragDirective, selectors: [["", "pblNgridColumnDrag", ""]], hostAttrs: [1, "cdk-drag"], hostVars: 2, hostBindings: function PblNgridColumnDragDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("cdk-drag-dragging", ctx._dragRef.isDragging());
    } }, inputs: { context: ["pblNgridColumnDrag", "context"], cdkDropList: "cdkDropList", rootElementSelectorClass: ["cdkDragRootElementClass", "rootElementSelectorClass"] }, exportAs: ["pblNgridColumnDrag"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
...
PblNgridDragResizeComponent.ɵfac = function PblNgridDragResizeComponent_Factory(t) { return new (t || PblNgridDragResizeComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.ViewportRuler), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDropRegistry), ɵngcc0.ɵɵdirectiveInject(CDK_DRAG_CONFIG), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality, 8)); };
PblNgridDragResizeComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PblNgridDragResizeComponent, selectors: [["pbl-ngrid-drag-resize"]], hostAttrs: [1, "pbl-ngrid-column-resizer"], hostVars: 2, hostBindings: function PblNgridDragResizeComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("dblclick", function PblNgridDragResizeComponent_dblclick_HostBindingHandler($event) { return ctx.onDoubleClick($event); });
    } if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("width", ctx.grabAreaWidth, "px");
    } }, inputs: { grabAreaWidth: "grabAreaWidth", context: "context" }, ngContentSelectors: _c0, decls: 1, vars: 0, template: function PblNgridDragResizeComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵprojection(0);
    } }, styles: [".pbl-ngrid-column-resizer{position:absolute;right:0;height:100%;cursor:col-resize;z-index:50000}"], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblDragDrop, [{
        type: Injectable,
...
const ɵCdkLazyDropList_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(CdkLazyDropList);
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkLazyDropList, [{
        type: Directive,
        args: [{
    ...
    }], null, { directContainerElement: [{
            type: Input,
            args: ['cdkDropListDirectContainerElement']
        }] }); })();
const ɵCdkLazyDrag_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(CdkLazyDrag);
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CdkLazyDrag, [{
        type: Directive,
        args: [{
    ...
    }], null, { rootElementSelectorClass: [{
            type: Input,
            args: ['cdkDragRootElementClass']
        }], cdkDropList: [{
            type: Input
        }] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblDragHandle, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc2.CdkDrag, decorators: [{
                type: Optional
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridRowReorderPluginDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc3.PblNgridComponent }, { type: ɵngcc3.PblNgridPluginController }, { type: ɵngcc0.ElementRef }, { type: ɵngcc2.DragDrop }, { type: ɵngcc0.ChangeDetectorRef }, { type: ɵngcc4.Directionality, decorators: [{
                type: Optional
            }] }, { type: ɵngcc2.CdkDropListGroup, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, { rowReorder: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridRowDragDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc2.CdkDropList, decorators: [{
                type: Inject,
                args: [CDK_DROP_LIST]
            }, {
                type: Optional
            ...
            }] }, { type: ɵngcc4.Directionality }, { type: ɵngcc2.DragDrop }, { type: ɵngcc0.ChangeDetectorRef }]; }, { context: [{
            type: Input,
            args: ['pblNgridRowDrag']
        }], cdkDropList: [{
            type: Input
        }], rootElementSelectorClass: [{
            type: Input,
            args: ['cdkDragRootElementClass']
        }] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridColumnReorderPluginDirective, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridColumnDragDirective, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDragResizeComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: ɵngcc1.ViewportRuler }, { type: ɵngcc2.DragDropRegistry }, { type: undefined, decorators: [{
                type: Inject,
                args: [CDK_DRAG_CONFIG]
...
PblNgridCellDraggerRefDirective.ɵfac = function PblNgridCellDraggerRefDirective_Factory(t) { return new (t || PblNgridCellDraggerRefDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridRegistryService)); };
PblNgridCellDraggerRefDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridCellDraggerRefDirective, selectors: [["", "pblNgridCellDraggerRef", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
PblNgridCellDraggerRefDirective.ctorParameters = () => [
    { type: TemplateRef },
    { type: PblNgridRegistryService }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridCellDraggerRefDirective, [{
        type: Directive,
        args: [{ selector: '[pblNgridCellDraggerRef]' }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: ɵngcc3.PblNgridRegistryService }]; }, null); })();
if (false) {
    /** @type {?} */
...
PblNgridAggregationContainerDirective.ɵfac = function PblNgridAggregationContainerDirective_Factory(t) { return new (t || PblNgridAggregationContainerDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DragDrop), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.CdkDropListGroup, 12)); };
PblNgridAggregationContainerDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridAggregationContainerDirective, selectors: [["", "pblAggregationContainer", ""]], hostAttrs: [1, "cdk-drop-list"], hostVars: 1, hostBindings: function PblNgridAggregationContainerDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("id", ctx.id);
    } }, inputs: { directContainerElement: ["cdkDropListDirectContainerElement", "directContainerElement"] }, exportAs: ["pblAggregationContainer"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: DragDrop, useExisting: PblDragDrop },
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridAggregationContainerDirective, [{
        type: Directive,
        args: [{
...
PblNgridCellResizerRefDirective.ɵfac = function PblNgridCellResizerRefDirective_Factory(t) { return new (t || PblNgridCellResizerRefDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.PblNgridRegistryService)); };
PblNgridCellResizerRefDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridCellResizerRefDirective, selectors: [["", "pblNgridCellResizerRef", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/** @nocollapse */
PblNgridCellResizerRefDirective.ctorParameters = () => [
    { type: TemplateRef },
    { type: PblNgridRegistryService }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridCellResizerRefDirective, [{
        type: Directive,
...
DragPluginDefaultTemplatesComponent.ɵfac = function DragPluginDefaultTemplatesComponent_Factory(t) { return new (t || DragPluginDefaultTemplatesComponent)(); };
DragPluginDefaultTemplatesComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DragPluginDefaultTemplatesComponent, selectors: [["pbl-drag-plugin-default-templates"]], decls: 2, vars: 0, consts: [[3, "context", 4, "pblNgridCellResizerRef"], ["cdkDragRootElementClass", "cdk-drag", 3, "pblNgridColumnDrag", 4, "pblNgridCellDraggerRef"], [3, "context"], ["cdkDragRootElementClass", "cdk-drag", 3, "pblNgridColumnDrag"]], template: function DragPluginDefaultTemplatesComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, DragPluginDefaultTemplatesComponent_pbl_ngrid_drag_resize_0_Template, 1, 1, "pbl-ngrid-drag-resize", 0);
        ɵngcc0.ɵɵtemplate(1, DragPluginDefaultTemplatesComponent_span_1_Template, 1, 1, "span", 1);
    } }, directives: [PblNgridCellResizerRefDirective,
        PblNgridCellDraggerRefDirective,
        PblNgridDragResizeComponent,
        PblNgridColumnDragDirective], encapsulation: 2, changeDetection: 0 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DragPluginDefaultTemplatesComponent, [{
        type: Component,
        args: [{
...
PblNgridDragModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridDragModule });
PblNgridDragModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridDragModule_Factory(t) { return new (t || PblNgridDragModule)(); }, imports: [[
            CommonModule,
            PblNgridModule,
            DragDropModule
        ],
        DragDropModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridDragModule, { declarations: function () { return [DragPluginDefaultTemplatesComponent,
        CdkLazyDropList,
        CdkLazyDrag,
        PblDragHandle,
        PblNgridRowReorderPluginDirective,
        ...
        PblNgridDragResizeComponent,
        PblNgridCellResizerRefDirective]; }, imports: function () { return [CommonModule,
        PblNgridModule,
        DragDropModule]; }, exports: function () { return [DragDropModule,
        CdkLazyDropList,
        CdkLazyDrag,
        PblDragHandle,
        PblNgridRowReorderPluginDirective,
        ...
        PblNgridAggregationContainerDirective,
        PblNgridDragResizeComponent,
        PblNgridCellResizerRefDirective]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridDragModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
...
export { CdkLazyDrag, CdkLazyDropList, PblDragHandle, PblNgridColumnDragDirective, PblNgridColumnReorderPluginDirective, PblNgridDragModule, PblNgridDragResizeComponent, PblNgridRowDragDirective, PblNgridRowReorderPluginDirective, PLUGIN_KEY$1 as ɵa, PLUGIN_KEY$2 as ɵb, PblDragDrop as ɵc, extendGrid as ɵd, extendGrid$1 as ɵe, DragPluginDefaultTemplatesComponent as ɵf, PblNgridCellDraggerRefDirective as ɵg, PblNgridAggregationContainerDirective as ɵh, PblNgridCellResizerRefDirective as ɵi };

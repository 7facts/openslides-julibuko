(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@pebula/ngrid'), require('rxjs/operators'), require('@angular/cdk/coercion'), require('@pebula/utils'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@pebula/ngrid/transpose', ['exports', '@angular/core', '@angular/common', '@pebula/ngrid', 'rxjs/operators', '@angular/cdk/coercion', '@pebula/utils', 'rxjs'], factory) :
    (global = global || self, factory((global.pebula = global.pebula || {}, global.pebula.ngrid = global.pebula.ngrid || {}, global.pebula.ngrid.transpose = {}), global.ng.core, global.ng.common, global.pebula.ngrid, global.rxjs.operators, global.ng.cdk.coercion, global.pebula.utils, global.rxjs));
}(this, (function (exports, core, common, ngrid, operators, coercion, utils, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PblNgridTransposePluginDirective = /** @class */ (function () {
        function PblNgridTransposePluginDirective(grid, pluginCtrl, config) {
             ...
             * @return {?}
             */
            function (e) { return e.kind === 'onInit'; })), operators.take(1), utils.UnRx(this, this.grid))
                .subscribe((/**
             * @param {?} e
             * @return {?}
             */

...
PblNgridCellTooltipDirective.ɵfac = function PblNgridCellTooltipDirective_Factory(t) { return new (t || PblNgridCellTooltipDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController)); };
PblNgridCellTooltipDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridCellTooltipDirective, selectors: [["", "cellTooltip", ""]], inputs: { canShow: ["cellTooltip", "canShow"], message: "message", position: "position", tooltipClass: "tooltipClass", showDelay: "showDelay", hideDelay: "hideDelay" }, exportAs: ["pblOverflowTooltip"] });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridCellTooltipDirective, [{
        type: Directive,
        args: [{ selector: '[cellTooltip]', exportAs: 'pblOverflowTooltip' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc0.Injector }, { type: ɵngcc1.PblNgridPluginController }]; }, { canShow: [{
            type: Input,
            args: ['cellTooltip']
        }], message: [{
            type: Input
...
PblNgridCellTooltipModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridCellTooltipModule });
PblNgridCellTooltipModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridCellTooltipModule_Factory(t) { return new (t || PblNgridCellTooltipModule)(ɵngcc0.ɵɵinject(PblNgridCellTooltipModule, 12), ɵngcc0.ɵɵinject(ɵngcc1.PblNgridConfigService)); }, imports: [[CommonModule, MatTooltipModule, OverlayModule, PblNgridModule, PblNgridTargetEventsModule],
        MatTooltipModule] });
/** @nocollapse */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridCellTooltipModule, { declarations: function () { return [PblNgridCellTooltipDirective]; }, imports: function () { return [CommonModule, MatTooltipModule, OverlayModule, PblNgridModule, PblNgridTargetEventsModule]; }, exports: function () { return [PblNgridCellTooltipDirective,
        MatTooltipModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridCellTooltipModule, [{
        type: NgModule,
        args: [{
    ...
    }], function () { return [{ type: PblNgridCellTooltipModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf

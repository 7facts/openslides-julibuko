...
import * as ɵngcc2 from '@angular/material/sort';
...
PblNgridMatSortDirective.ɵfac = function PblNgridMatSortDirective_Factory(t) { return new (t || PblNgridMatSortDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridComponent), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.PblNgridPluginController), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.MatSort)); };
PblNgridMatSortDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PblNgridMatSortDirective, selectors: [["pbl-ngrid", "matSort", ""]], exportAs: ["pblMatSort"] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridMatSortDirective, [{
        type: Directive,
        args: [{ selector: 'pbl-ngrid[matSort]', exportAs: 'pblMatSort' }]
    }], function () { return [{ type: ɵngcc1.PblNgridComponent }, { type: ɵngcc1.PblNgridPluginController }, { type: ɵngcc2.MatSort }]; }, null); })();
if (false) {
    /**
     * @type {?}
     * @private
...
PblNgridMatSortModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PblNgridMatSortModule });
PblNgridMatSortModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PblNgridMatSortModule_Factory(t) { return new (t || PblNgridMatSortModule)(ɵngcc0.ɵɵinject(ɵngcc1.PblNgridRegistryService), ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver)); }, imports: [[CommonModule, MatButtonModule, MatSortModule, PblNgridModule],
        MatSortModule] });
/** @nocollapse */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PblNgridMatSortModule, { declarations: function () { return [PblNgridMatSortDirective]; }, imports: function () { return [CommonModule, MatButtonModule, MatSortModule, PblNgridModule]; }, exports: function () { return [PblNgridMatSortDirective,
        MatSortModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PblNgridMatSortModule, [{
        type: NgModule,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc1.PblNgridRegistryService }, { type: ɵngcc0.ComponentFactoryResolver }]; }, null); })();
if (false) {
    /**
     * @type {?}
     * @private
